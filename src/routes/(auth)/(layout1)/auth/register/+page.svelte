<script lang="ts">
  ...
  import { registerUserSchema, type RegisterUserSchema } from './schema';
...
<div class="py-20">
  <div class="flex flex-col items-center w-full">
    <Card.Root class="w-full md:w-1/2 lg:w-1/3 ">
      <Card.Header>
        <Card.Title>Register</Card.Title>
        <Card.Description>Register to move ahead in your career</Card.Description>
      </Card.Header>
      <Card.Content>
        <Form.Root method="POST" {form} schema={registerUserSchema} let:config>
          ...
          <Form.Field {config} name="email">
            <Form.Item>
              ...
              <Form.Description>Please login with your email.</Form.Description>
              <Form.Validation />
            </Form.Item>
          </Form.Field>
...
<div class="py-20">
  <div class="flex flex-col items-center w-full">
    ...
    <Card class="w-full mt-6" padding="xl" size="md">
